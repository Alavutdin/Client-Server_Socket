...
public class ClientManager implements Runnable {
    ...
    // Дескриптор для связи между клиентом и сервером по протоколу IP.
    private BufferedReader bufferedReader;
    // Класс библиотеки Java, предназначенный для чтения данных из потока байтов.
    private BufferedWriter bufferedWriter;
    // Класс библиотеки Java, используемый для записи данных в поток байтов.
    private String name;
    // Имя клиента.
